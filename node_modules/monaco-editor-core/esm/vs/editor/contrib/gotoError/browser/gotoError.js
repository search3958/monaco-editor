...
export class NextMarkerAction extends MarkerNavigationAction {
    ...
    static { this.LABEL = nls.localize2(1031, "Go to Next Problem (Error, Warning, Info)"); }
    constructor() {
        super(true, false, {
            ...
            menuOpts: {
                ...
                icon: registerIcon('marker-navigation-next', Codicon.arrowDown, nls.localize(1027, 'Icon for goto next marker.')),
                group: 'navigation',
                order: 1
            }
        });
...
export class PrevMarkerAction extends MarkerNavigationAction {
    ...
    static { this.LABEL = nls.localize2(1032, "Go to Previous Problem (Error, Warning, Info)"); }
    constructor() {
        super(false, false, {
            ...
            menuOpts: {
                ...
                icon: registerIcon('marker-navigation-previous', Codicon.arrowUp, nls.localize(1028, 'Icon for goto previous marker.')),
                group: 'navigation',
                order: 2
            }
        });
...
export class NextMarkerInFilesAction extends MarkerNavigationAction {
    ...
    constructor() {
        super(true, true, {
            ...
            label: nls.localize2(1033, "Go to Next Problem in Files (Error, Warning, Info)"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
            ...
            menuOpts: {
                ...
                title: nls.localize(1029, "Next &&Problem"),
                group: '6_problem_nav',
                order: 1
            }
        });
...
export class PrevMarkerInFilesAction extends MarkerNavigationAction {
    ...
    constructor() {
        super(false, true, {
            ...
            label: nls.localize2(1034, "Go to Previous Problem in Files (Error, Warning, Info)"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarGoMenu,
                title: nls.localize(1030, "Previous &&Problem"),
                group: '6_problem_nav',
                order: 2
            }
        });
