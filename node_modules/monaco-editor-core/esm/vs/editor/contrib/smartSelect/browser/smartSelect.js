...
class GrowSelectionAction extends AbstractSmartSelect {
    constructor() {
        super(true, {
            ...
            label: nls.localize2(1417, "Expand Selection"),
            ...
            menuOpts: {
                ...
                group: '1_basic',
                title: nls.localize(1415, "&&Expand Selection"),
                order: 2
            }
        });
    }
...
class ShrinkSelectionAction extends AbstractSmartSelect {
    constructor() {
        super(false, {
            ...
            label: nls.localize2(1418, "Shrink Selection"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '1_basic',
                title: nls.localize(1416, "&&Shrink Selection"),
                order: 3
            }
        });
    }
