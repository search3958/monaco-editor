...
export const ctxHasSymbols = new RawContextKey('hasSymbols', false, localize(1106, "Whether there are symbol locations that can be navigated via keyboard-only."));
