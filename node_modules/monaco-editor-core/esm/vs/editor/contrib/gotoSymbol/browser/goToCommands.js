...
export class DefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getDefinitionsAtPosition(languageFeaturesService.definitionProvider, model, position, false, token), nls.localize(1050, 'Definitions'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize(1051, "No definition found for '{0}'", info.word)
            : nls.localize(1052, "No definition found");
    }
...
registerAction2(class GoToDefinitionAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(1076, "Go to Definition"),
                mnemonicTitle: nls.localize(1053, "Go to &&Definition"),
            },
...
registerAction2(class OpenDefinitionToSideAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(1077, "Open Definition to the Side"),
...
registerAction2(class PeekDefinitionAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(1078, "Peek Definition"),
...
class DeclarationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getDeclarationsAtPosition(languageFeaturesService.declarationProvider, model, position, false, token), nls.localize(1054, 'Declarations'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize(1055, "No declaration found for '{0}'", info.word)
            : nls.localize(1056, "No declaration found");
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToDeclarationAction extends DeclarationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(1079, "Go to Declaration"),
                mnemonicTitle: nls.localize(1057, "Go to &&Declaration"),
            },
    ...
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize(1058, "No declaration found for '{0}'", info.word)
            : nls.localize(1059, "No declaration found");
    }
});
registerAction2(class PeekDeclarationAction extends DeclarationAction {
    constructor() {
        super({
            ...
            title: nls.localize2(1080, "Peek Declaration"),
...
class TypeDefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getTypeDefinitionsAtPosition(languageFeaturesService.typeDefinitionProvider, model, position, false, token), nls.localize(1060, 'Type Definitions'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize(1061, "No type definition found for '{0}'", info.word)
            : nls.localize(1062, "No type definition found");
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(1081, "Go to Type Definition"),
                mnemonicTitle: nls.localize(1063, "Go to &&Type Definition"),
            },
...
registerAction2(class PeekTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(1082, "Peek Type Definition"),
...
class ImplementationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getImplementationsAtPosition(languageFeaturesService.implementationProvider, model, position, false, token), nls.localize(1064, 'Implementations'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize(1065, "No implementation found for '{0}'", info.word)
            : nls.localize(1066, "No implementation found");
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(1083, "Go to Implementations"),
                mnemonicTitle: nls.localize(1067, "Go to &&Implementations"),
            },
...
registerAction2(class PeekImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(1084, "Peek Implementations"),
...
class ReferencesAction extends SymbolNavigationAction {
    _getNoResultFoundMessage(info) {
        return info
            ? nls.localize(1068, "No references found for '{0}'", info.word)
            : nls.localize(1069, "No references found");
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(1085, "Go to References"),
                mnemonicTitle: nls.localize(1070, "Go to &&References"),
            },
    ...
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getReferencesAtPosition(languageFeaturesService.referenceProvider, model, position, true, false, token), nls.localize(1071, 'References'));
    }
});
registerAction2(class PeekReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: nls.localize2(1086, "Peek References"),
            precondition: ContextKeyExpr.and(EditorContextKeys.hasReferenceProvider, PeekContext.notInPeekEditor, EditorContextKeys.isInEmbeddedEditor.toNegated()),
            menu: {
                id: MenuId.EditorContextPeek,
                group: 'peek',
    ...
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getReferencesAtPosition(languageFeaturesService.referenceProvider, model, position, false, false, token), nls.localize(1072, 'References'));
    }
});
//#endregion
...
class GenericGoToLocationAction extends SymbolNavigationAction {
    constructor(config, _references, _gotoMultipleBehaviour) {
        super(config, {
            ...
            title: nls.localize2(1087, "Go to Any Symbol"),
    ...
    async _getLocationModel(languageFeaturesService, _model, _position, _token) {
        return new ReferencesModel(this._references, nls.localize(1073, 'Locations'));
    }
    _getNoResultFoundMessage(info) {
        return info && nls.localize(1074, "No results for '{0}'", info.word) || '';
    }
    _getGoToPreference(editor) {
...
CommandsRegistry.registerCommand({
    ...
    handler: (accessor, resource, position) => {
        ...
        return codeEditorService.openCodeEditor({ resource }, codeEditorService.getFocusedCodeEditor()).then(control => {
            ...
            const references = createCancelablePromise(token => getReferencesAtPosition(languageFeaturesService.referenceProvider, control.getModel(), corePosition.Position.lift(position), false, false, token).then(references => new ReferencesModel(references, nls.localize(1075, 'References'))));
