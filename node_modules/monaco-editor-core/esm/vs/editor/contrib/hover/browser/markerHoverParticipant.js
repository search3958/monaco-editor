...
let MarkerHoverParticipant = class MarkerHoverParticipant {
    ...
    _renderMarkerStatusbar(context, markerHover) {
        ...
        if (markerHover.marker.severity === MarkerSeverity.Error || markerHover.marker.severity === MarkerSeverity.Warning || markerHover.marker.severity === MarkerSeverity.Info) {
            ...
            if (markerController) {
                context.statusBar.addAction({
                    label: nls.localize(1148, "View Problem"),
        ...
        if (!this._editor.getOption(104 /* EditorOption.readOnly */)) {
            ...
            const updatePlaceholderDisposable = this.recentMarkerCodeActionsInfo && !this.recentMarkerCodeActionsInfo.hasCodeActions ? Disposable.None : disposableTimeout(() => quickfixPlaceholderElement.textContent = nls.localize(1150, "Checking for quick fixes..."), 200, disposables);
            ...
            codeActionsPromise.then(actions => {
                ...
                if (!this.recentMarkerCodeActionsInfo.hasCodeActions) {
                    actions.dispose();
                    quickfixPlaceholderElement.textContent = nls.localize(1151, "No quick fixes available");
                    return;
                }
                ...
                context.statusBar.addAction({
                    label: nls.localize(1152, "Quick Fix..."),
