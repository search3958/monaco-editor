...
export class ShowOrFocusHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1118, "Show or Focus Hover"),
            ...
            metadata: {
                description: nls.localize2(1119, 'Show or focus the editor hover which shows documentation, references, and other content for a symbol at the current cursor position.'),
                args: [{
                        name: 'args',
                        schema: {
                            type: 'object',
                            properties: {
                                'focus': {
                                    ...
                                    enumDescriptions: [
                                        nls.localize(1115, 'The hover will not automatically take focus.'),
                                        nls.localize(1116, 'The hover will take focus only if it is already visible.'),
                                        nls.localize(1117, 'The hover will automatically take focus when it appears.'),
                                    ],
...
export class ShowDefinitionPreviewHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1120, "Show Definition Preview Hover"),
            ...
            precondition: undefined,
            metadata: {
                description: nls.localize2(1121, 'Show the definition preview hover in the editor.'),
            },
        });
    }
    run(accessor, editor) {
...
export class HideContentHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1122, "Hide Hover"),
...
export class ScrollUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1123, "Scroll Up Hover"),
            ...
            metadata: {
                description: nls.localize2(1124, 'Scroll up the editor hover.')
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1125, "Scroll Down Hover"),
            ...
            metadata: {
                description: nls.localize2(1126, 'Scroll down the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollLeftHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1127, "Scroll Left Hover"),
            ...
            metadata: {
                description: nls.localize2(1128, 'Scroll left the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollRightHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1129, "Scroll Right Hover"),
            ...
            metadata: {
                description: nls.localize2(1130, 'Scroll right the editor hover.')
            },
        });
    }
    run(accessor, editor) {
...
export class PageUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1131, "Page Up Hover"),
            ...
            metadata: {
                description: nls.localize2(1132, 'Page up the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class PageDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1133, "Page Down Hover"),
            ...
            metadata: {
                description: nls.localize2(1134, 'Page down the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class GoToTopHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1135, "Go To Top Hover"),
            ...
            metadata: {
                description: nls.localize2(1136, 'Go to the top of the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class GoToBottomHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1137, "Go To Bottom Hover"),
            ...
            metadata: {
                description: nls.localize2(1138, 'Go to the bottom of the editor hover.')
            },
        });
    }
    run(accessor, editor) {
