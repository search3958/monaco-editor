...
export class IndentationToSpacesAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1157, "Convert Indentation to Spaces"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1158, "Convert the tab indentation to spaces."),
            }
        });
    }
    run(accessor, editor) {
...
export class IndentationToTabsAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1159, "Convert Indentation to Tabs"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1160, "Convert the spaces indentation to tabs."),
            }
        });
    }
    run(accessor, editor) {
    ...
    run(accessor, editor) {
        ...
        const picks = [1, 2, 3, 4, 5, 6, 7, 8].map(n => ({
            ...
            description: (n === creationOpts.tabSize && n === modelOpts.tabSize
                ? nls.localize(1153, "Configured Tab Size")
                : n === creationOpts.tabSize
                    ? nls.localize(1154, "Default Tab Size")
                    : n === modelOpts.tabSize
                        ? nls.localize(1155, "Current Tab Size")
                        : undefined)
        }));
        // auto focus the tabSize set for the current editor
        const autoFocusIndex = Math.min(model.getOptions().tabSize - 1, 7);
        setTimeout(() => {
            quickInputService.pick(picks, { placeHolder: nls.localize(1156, "Select Tab Size for Current File"), activeItem: picks[autoFocusIndex] }).then(pick => {
                if (pick) {
...
export class IndentUsingTabs extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(false, false, {
            ...
            label: nls.localize2(1161, "Indent Using Tabs"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1162, "Use indentation with tabs."),
            }
        });
    }
}
export class IndentUsingSpaces extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, false, {
            ...
            label: nls.localize2(1163, "Indent Using Spaces"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1164, "Use indentation with spaces."),
            }
        });
    }
}
export class ChangeTabDisplaySize extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, true, {
            ...
            label: nls.localize2(1165, "Change Tab Display Size"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1166, "Change the space size equivalent of the tab."),
            }
        });
    }
}
export class DetectIndentation extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1167, "Detect Indentation from Content"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1168, "Detect the indentation from content."),
            }
        });
    }
    run(accessor, editor) {
...
export class ReindentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1169, "Reindent Lines"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1170, "Reindent the lines of the editor."),
            },
...
export class ReindentSelectedLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1171, "Reindent Selected Lines"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1172, "Reindent the selected lines of the editor."),
            },
            canTriggerInlineEdits: true,
        });
    }
