...
export const UndoCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '',
            title: nls.localize(72, "Undo"),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '1_do',
            title: nls.localize(73, "Undo"),
            order: 1
        }]
}));
...
export const RedoCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            ...
            menuId: MenuId.CommandPalette,
            group: '',
            title: nls.localize(75, "Redo"),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '1_do',
            title: nls.localize(76, "Redo"),
            order: 2
        }]
}));
...
export const SelectAllCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            ...
            menuId: MenuId.CommandPalette,
            group: '',
            title: nls.localize(78, "Select All"),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '9_select',
            title: nls.localize(79, "Select All"),
            order: 1
        }]
}));
